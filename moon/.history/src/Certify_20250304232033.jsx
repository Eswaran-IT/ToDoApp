...
const Certify = () => {
  ...
  return (
    <div className="flex flex-col mt-3 items-center justify-center bg-purple-800 text-white">
      ...
      <div className="relative w-full max-w-2xl h-auto bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden">
