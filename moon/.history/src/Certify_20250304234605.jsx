...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-purple-800 text-white p-4">
        ...
        {Object.keys(certificateMap).map((category) => (
          <motion.button
            ...
            className={`px-3 py-1 text-sm md:text-base font-semibold rounded-lg transition duration-300 ${
              activeCategory === category ? "bg--600 text-white" : "bg-white text-black hover:bg-blue-500"
            }`}
