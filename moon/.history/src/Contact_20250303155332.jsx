...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-purple-800  sm:px-6 lg:px-8">
      <div className="w-full max-w-lg bg-white shadow-lg rounded-xl space-y-6">
