...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-gradient-to-br from-blue-800 to-blue-900 text-white p-6">
      <motion.h2
      ...
      <motion.div
        className="w-full text-center text-lg font-semibold mb-4 bg-white text-blue-900 p-2 rounded-lg shadow-md"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
      ...
      <motion.div
        className="w-full flex justify-center gap-3 flex-wrap max-w-4xl mb-4"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
      ...
      <motion.div
        className="relative w-full max-w-4xl h-[70vh] bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden"
