...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-gradient-to-br from-blue-700 to-blue-900 text-white p-6">
      <motion.h2
      ...
      <motion.div
        className="relative w-full max-w-6xl h-[80vh] bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden"
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5 }}
      >
