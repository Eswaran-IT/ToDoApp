...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-gradient-to-br from-[#1e1e2e] to-[#2a2a3b] text-white p-4">
      {/* Title */}
      <motion.h2
        className="text-3xl md:text-4xl font-bold mb-2 text-center text-purple-400"
      ...
      <motion.div
        className="text-lg md:text-xl font-semibold bg-purple-700 px-4 py-2 rounded-lg shadow-md text-white mb-4"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
        ...
        {Object.keys(certificateMap).map((category) => (
          <motion.button
            ...
            className={`px-3 py-1 text-sm md:text-base font-semibold rounded-lg transition duration-300 ${
              activeCategory === category ? "bg-purple-600" : "bg-gray-700 hover:bg-purple-500"
            }`}
      ...
      {/* Certificate Display */}
      <div className="relative w-full max-w-3xl h-[70vh] md:h-[75vh] flex justify-center items-center bg-gray-300 rounded-lg shadow-2xl overflow-hidden">
        ...
        {certificates.length > 1 && (
          <>
            <motion.button
              ...
              className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-purple-700 p-3 rounded-full opacity-80 hover:opacity-100 transition duration-300"
            >
            ...
            <motion.button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-purple-700 p-3 rounded-full opacity-80 hover:opacity-100 transition duration-300"
            >
