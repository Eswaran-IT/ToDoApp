      ...
      >
        {projects.map((project, index) => (
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg w-80 flex-shrink-0 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
          >
            <a href={project.link} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center p-6">
