...
const Certify = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-500 to-indigo-600 p-6">
      ...
      <motion.div
        className="w-screen flex flex-wrap justify-center gap-3 mb-6 px-4"
      ...
      <motion.div
        className="relative w-screen h-[70vh] max-w-4xl bg-white rounded-lg shadow-md overflow-hidden flex justify-center items-center"
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.5 }}
      >
            ...
            {certificates.length > 1 && (
              <>
                <motion.button
                  ...
                  className="absolute top-1/2 left-6 transform -translate-y-1/2 text-white bg-purple-600 p-4 rounded-full opacity-70 hover:opacity-100 transition duration-200"
                >
                  <FaArrowLeft />
                </motion.button>
                <motion.button
                  ...
                  className="absolute top-1/2 right-6 transform -translate-y-1/2 text-white bg-purple-600 p-4 rounded-full opacity-70 hover:opacity-100 transition duration-200"
                >
                  <FaArrowRight />
                </motion.button>
              </>
