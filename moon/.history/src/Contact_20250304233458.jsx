...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-white sm:px-6 lg:px-8">
      <div className="w-full max-w-lg bg-white shadow-lg rounded-xl p-8 space-y-6">
        ...
        >
          ...
          <motion.button
            type="submit"
            className={`w-full py-3 text-white font-semibold text-lg rounded-lg shadow-md transition-all duration-300 ${
              loading ? "bg-gray-500 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500"
            }`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
