...
const Certify = () => {
  ...
  return (
    <div className="w-full h-screen bg-gray-50 flex flex-col items-center justify-start p-4">
      ...
      <div className="w-full max-w-sm p-3 mb-6 bg-purple-600 text-white rounded-lg shadow-md text-center">
        <p className="text-sm">
      ...
      <div className="w-full flex flex-wrap justify-center gap-2 mb-6">
        {Object.keys(certificateMap).map((category, index) => (
          <button
            key={index}
            className={`px-3 py-1 text-xs text-gray-800 font-medium rounded-md transition duration-200 ease-in-out ${
      ...
      <div className="relative w-full h-[60vh] max-w-[900px] bg-white rounded-lg shadow-lg overflow-hidden flex justify-center items-center mb-8">
