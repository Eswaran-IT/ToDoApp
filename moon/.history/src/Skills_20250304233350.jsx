      ...
      {skills.map((skill) => {
        ...
        return (
          <motion.div
            ...
            className="flex justify-center items-center transform hover:scale-110 hover:shadow-lg hover:rotate-3 transition-all duration-300"
          >
            <a
              href={skill.link}
              target="_blank"
            ...
            >
              <img
                src={skill.imgSrc}
                alt={`${skill.name} Logo`}
                className="h-24 w-24 md:h-28 md:w-28 object-contain transition-all duration-300"
