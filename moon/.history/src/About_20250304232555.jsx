  ...
  return (
    ...
    >
      <div className="text-center p-6 m-0">
        ...
        <h1
          className="text-4xl md:text-6xl font-bold text-purple-800 mb-4 shadow-lg"
          data-aos="fade-up"
        >
        ...
        <p
          className="text-lg md:text-2xl text-purple-600 mb-4 italic shadow-lg"
          data-aos="fade-up"
        >
        ...
        <div className="flex justify-center mt-8" data-aos="fade-up">
          <div className="w-32 h-32 border-4 border-purple-800 rounded-full shadow-xl"></div>
        </div>
      </div>
    </section>
  );
