...
const Certify = () => {
  ...
  return (
    <div className="w-full h-screen bg-white flex flex-col items-center justify-start p-4">
      ...
      </div>[plugin:vite:import-analysis] Failed to resolve import "react-icons/fa" from "src/Certify.jsx". Does the file exist?
C:/Users/Eswaran/Desktop/moon/src/Certify.jsx:2:42
17 |  var _s = $RefreshSig$();
18 |  import React, { useState, useEffect } from "react";
19 |  import { FaArrowLeft, FaArrowRight } from "react-icons/fa";
   |                                             ^
20 |  import certificatesData from "./assets/certificates.json";
21 |  const Certify = () => {
    at TransformPluginContext._formatLog (file:///C:/Users/Eswaran/De
    </div>
  );
};
