...
import { FaGit, FaDocker, FaMysql, FaMongo, FaGitAlt, FaPostman } from 'react-icons/fa';
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <ul className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
        ...
        {/* MongoDB */}
        <li className="text-center hover:scale-105 transition duration-300 transform">
          <FaMongo size="3em" className="text-[#47A248] mb-2" />
          <p className="text-purple-600">MongoDB</p>
        </li>
        {/* Spring */}
        <li className="text-center hover:scale-105 transition duration-300 transform">
