...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[100vh] flex flex-col items-center justify-center bg-gradient-to-br from-[#4b0082] to-[#6a0dad] text-white p-4">
      {/* Title */}
      ...
      {/* Certificate Display */}
      <div className="relative w-full max-w-2xl h-[70vh] bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden">
        {certificates.length > 0 ? (
          ...
          <motion.p className="text-center text-gray-500 text-xl">No certificates available.</motion.p>
        )}

        {/* Navigation Buttons - **Compact & Neat** */}
